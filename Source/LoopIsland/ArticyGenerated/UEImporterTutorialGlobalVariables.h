...
class LOOPISLAND_API UUEImporterTutorialGameStateVariables : public UArticyBaseVariableSet
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class LOOPISLAND_API UUEImporterTutorialGlobalVariables : public UArticyGlobalVariables
{
	GENERATED_BODY()
